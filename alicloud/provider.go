...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_bastionhost_user_public_keys":                 dataSourceAlicloudBastionhostUserPublicKeys(),
			...
			"alicloud_bastionhost_host_network_domains":             dataSourceAlicloudBastionhostHostNetworkDomains(),
